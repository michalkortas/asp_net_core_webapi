...
namespace Evento.Infrastructure.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        {
            new Event(Guid.NewGuid(), "Koncert Deep Purple", "Pożegnalna trasa staruszków", DateTime.UtcNow.AddHours(2), DateTime.UtcNow.AddHours(4)),

            new Event(Guid.NewGuid(), "Koncert DM", "Open'er", DateTime.UtcNow.AddHours(10), DateTime.UtcNow.AddHours(12))
        };
